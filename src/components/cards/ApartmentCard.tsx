...
export const ApartmentCard: FC<ApartmentCardProps> = ({ number, type, area, status, floor }) => {
  ...
  const getImage = (number: string) => {
    if (number === '1') return 'http://aislike.rs/BOSS/3d stanovi/1-18.png';
    if (number === '2') return 'http://aislike.rs/BOSS/3d stanovi/2-19.png';
    if (number === '3') return 'http://aislike.rs/BOSS/3d stanovi/3-20.png';
    if (number === '4') return 'http://aislike.rs/BOSS/3d stanovi/4-12-21-29.png';
    if (number === '5') return 'http://aislike.rs/BOSS/3d stanovi/5-13-22-30.png';
    if (number === '6') return 'http://aislike.rs/BOSS/3d stanovi/6-14-23-31.png';
    if (number === '7') return 'http://aislike.rs/BOSS/3d stanovi/7-15-24.png';
    if (number === '8') return 'http://aislike.rs/BOSS/3d stanovi/8-16-25.png';
    if (number === '9') return 'http://aislike.rs/BOSS/3d stanovi/9-17-26.png';
    if (number === '10') return 'http://aislike.rs/BOSS/3d stanovi/10-27.png';
    if (number === '11') return 'http://aislike.rs/BOSS/3d stanovi/11-28.png';
    if (number === '12') return 'http://aislike.rs/BOSS/3d stanovi/4-12-21-29.png';
    if (number === '13') return 'http://aislike.rs/BOSS/3d stanovi/5-13-22-30.png';
    if (number === '14') return 'http://aislike.rs/BOSS/3d stanovi/6-14-23-31.png';
    if (number === '15') return 'http://aislike.rs/BOSS/3d stanovi/7-15-24.png';
    if (number === '16') return 'http://aislike.rs/BOSS/3d stanovi/8-16-25.png';
    if (number === '17') return 'http://aislike.rs/BOSS/3d stanovi/9-17-26.png';
    if (number === '18') return 'http://aislike.rs/BOSS/3d stanovi/1-18.png';
    if (number === '19') return 'http://aislike.rs/BOSS/3d stanovi/2-19.png';
    if (number === '20') return 'http://aislike.rs/BOSS/3d stanovi/3-20.png';
    if (number === '21') return 'http://aislike.rs/BOSS/3d stanovi/4-12-21-29.png';
    if (number === '22') return 'http://aislike.rs/BOSS/3d stanovi/5-13-22-30.png';
    if (number === '23') return 'http://aislike.rs/BOSS/3d stanovi/6-14-23-31.png';
    if (number === '24') return 'http://aislike.rs/BOSS/3d stanovi/7-15-24.png';
    if (number === '26') return 'http://aislike.rs/BOSS/3d stanovi/9-17-26.png';
    if (number === '27') return 'http://aislike.rs/BOSS/3d stanovi/10-27.png';
    if (number === '28') return 'http://aislike.rs/BOSS/3d stanovi/11-28.png';
    if (number === '29') return 'http://aislike.rs/BOSS/3d stanovi/4-12-21-29.png';
    if (number === '30') return 'http://aislike.rs/BOSS/3d stanovi/5-13-22-30.png';
    if (number === '31') return 'http://aislike.rs/BOSS/3d stanovi/6-14-23-31.png';
    if (number === '32') return 'http://aislike.rs/BOSS/3d stanovi/32.png';
    if (number === '33') return 'http://aislike.rs/BOSS/3d stanovi/33.png';
    if (number === '34') return 'http://aislike.rs/BOSS/3d stanovi/34.png';
    return '';
  };
