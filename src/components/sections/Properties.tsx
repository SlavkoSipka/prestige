      ...
      <div className="max-w-7xl mx-auto px-8">
        ...
        <div ref={cardsRef} className={`grid grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-8 ${showContent ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-16'} transition-all duration-1000 delay-400`}>
          {[
            ...
            <div key={index} className="bg-gradient-to-br from-[#1B3964] to-[#0B1A2B] backdrop-blur-sm border border-marina-gold/20 rounded-lg overflow-hidden transition-all duration-500 hover:bg-marina-blue hover:border-marina-gold/40 shadow-lg group h-full">
